...
import { countries } from '@/modules/Checkout/constants/countries';
...
import {
  ...
  setLastName,
  setPhoneNumber,
} from '@/modules/Checkout/store/reducers/mainReducer';
    ...
    <div className={styles.payment}>
      ...
      <div className={styles.payment__inputs}>
        <div className={styles.payment__inputsRow}>
          <CustomInput onChangeCallback={setFirstName} value={firstName} isRequired={true} label="First Name" id="firstName" placeholder="First Name" />
          <CustomInput onChangeCallback={setLastName} value={lastName} isRequired={true} label="Last Name" id="lastName" placeholder="Last Name" />
        </div>
        <CustomInput onChangeCallback={setEmail} value={email} isRequired={true} label="Contact Email" id="email" placeholder="Contact Email" />
          ...
          <>
            ...
            <div className={styles.payment__inputsRow}>
              <div className={styles.input}>
                ...
                <select onChange={(e) => dispatch(setCountry(e.target.value))} className={styles.input__item} value={country} name="countries" id="country">
                  {countries.map((el) => (
